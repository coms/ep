...
public class Problem47 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < primesLimit; i++) {
			...
			primes.add(Pair.with(prime * prime, prime));
			primes.add(Pair.with(prime * prime * prime, prime));
			primes.add(Pair.with(prime * prime * prime * prime, prime));
			primes.add(Pair.with(prime * prime * prime * prime * prime, prime));
		}
